...
TokenCppKind_Internal = 148,
TokenCppKind_LocalPersist = 149,
TokenCppKind_GlobalVariable = 150,
TokenCppKind_Virtual = 151,
TokenCppKind_AlignAs = 152,
TokenCppKind_Explicit = 153,
TokenCppKind_NoExcept = 154,
TokenCppKind_NullPtr = 155,
TokenCppKind_Operator = 156,
TokenCppKind_Register = 157,
TokenCppKind_This = 158,
TokenCppKind_ThreadLocal = 159,
TokenCppKind_SizeOf = 160,
TokenCppKind_AlignOf = 161,
TokenCppKind_DeclType = 162,
TokenCppKind_TypeID = 163,
TokenCppKind_New = 164,
TokenCppKind_Delete = 165,
TokenCppKind_LiteralTrue = 166,
TokenCppKind_LiteralFalse = 167,
TokenCppKind_Identifier = 168,
TokenCppKind_PPInclude = 169,
TokenCppKind_PPVersion = 170,
TokenCppKind_PPDefine = 171,
TokenCppKind_PPUndef = 172,
TokenCppKind_PPIf = 173,
TokenCppKind_PPIfDef = 174,
TokenCppKind_PPIfNDef = 175,
TokenCppKind_PPElse = 176,
TokenCppKind_PPElIf = 177,
TokenCppKind_PPEndIf = 178,
TokenCppKind_PPError = 179,
TokenCppKind_PPImport = 180,
TokenCppKind_PPUsing = 181,
TokenCppKind_PPLine = 182,
TokenCppKind_PPPragma = 183,
TokenCppKind_PPUnknown = 184,
TokenCppKind_PPDefined = 185,
TokenCppKind_COUNT = 186,
};
